...
class setting_config:
    ...
    if datasets_name == 'synapse':
        ...
        data_path = '/root/autodl-tmp/Medical_Project/data/synapse/project_TransUNet/data/Synapse/train_npz'
        datasets = Synapse_dataset
        # list_dir = './data/Synapse/lists/lists_Synapse/'
        list_dir = '/root/autodl-tmp/Medical_Project/data/synapse/project_TransUNet/TransUNet/lists/lists_Synapse'
        # volume_path = './data/Synapse/test_vol_h5/'
        volume_path = '/root/autodl-tmp/Medical_Project/data/synapse/project_TransUNet/data/Synapse/test_vol_h5'
    else:
